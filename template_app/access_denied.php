...
echo "<p style='text-align:center'><a href='/{{TENANT_DIR}}/index.php?page=dashboard'>Retour au dashboard</a></p>";
 -->
    ...
    <div class="card shadow-sm mx-auto" style="max-width:600px">
      <div class="card-body text-center">
        ...
        <?php if (!empty($_SESSION['user_id'])): ?>
          <a href="/{{TENANT_DIR}}/index.php?page=dashboard" class="btn btn-primary">Retour au tableau de bord</a>
        <?php else: ?>
          <a href="/{{TENANT_DIR}}/login.php" class="btn btn-primary">Se connecter</a>
        <?php endif; ?>
      </div>
    </div>
  </div>
