    ...
    <?php endif; ?>
      ...
      <li class="sidebar-item">
        ...
        <ul id="posMenu" class="sidebar-dropdown">
          <?php if (checkPermission('pos.view')): ?><a class="nav-link" href="/{{TENANT_DIR}}/index.php?page=pos"><i class="fas fa-plus"></i> Ajouter</a><?php endif; ?>
          <?php if (checkPermission('pos.view')): ?><a class="nav-link" href="/{{TENANT_DIR}}/index.php?page=pos-liste"><i class="fa fa-shopping-cart"></i> Liste</a><?php endif; ?>
        </ul>
      </li>
      <?php endif; ?>
      ...
      <li class="sidebar-item">
        ...
        <ul id="tresorerieMenu" class="sidebar-dropdown">
          ...
          <?php if (checkPermission('operations.autres.view')): ?><a class="nav-link" href="/{{TENANT_DIR}}/index.php?page=autres_operations"><i class="fa fa-exchange-alt"></i> Autres opérations</a><?php endif; ?>
        </ul>
      </li>
      <?php endif; ?>
