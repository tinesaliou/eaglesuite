...
<header class="app-topbar">
  <div class="d-flex align-items-center">
    ...
    <div class="brand d-flex align-items-center">
      <img src="/{{TENANT_DIR}}/public/icone/eaglesuite.png" alt="EagleSuite" />
      ...
      <div class="topbar-center d-none d-md-block text-center">
        ...
        <div style="font-weight:600;">
          <?= htmlspecialchars($entreprise['nom'] ?? 'Entreprise') ?>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="dropdown">
      <a class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="d-none d-sm-block">
          <div style="font-weight:600"><?= htmlspecialchars($utilisateur['nom'] ?? 'Utilisateur') ?></div>
          <small class="text-muted"><?= htmlspecialchars($utilisateur['email'] ?? '') ?></small>
        </div>
      </a>
      <ul class="dropdown-menu dropdown-menu-end">
        <li><a class="dropdown-item" href="/{{TENANT_DIR}}/index.php?page=profil"><i class="fa fa-user me-2"></i>Mon profil</a></li>
        <li><hr class="dropdown-divider"></li>
        <li><a class="dropdown-item text-danger" href="/{{TENANT_DIR}}/deconnexion.php"><i class="fa fa-sign-out-alt me-2"></i>Déconnexion</a></li>
      </ul>
    </div>
  </div>
</header>
