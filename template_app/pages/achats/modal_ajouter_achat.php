...
<div class="modal fade" id="ajouterAchatModal" tabindex="-1" aria-labelledby="ajouterAchatLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="formAjouterAchat" method="POST" action="/{{TENANT_DIR}}/api/achats/ajouter.php">
...
function mettreAJourStock(index) {
  try {
    ...
    fetch(`/{{TENANT_DIR}}/api/achats/get_stock.php?produit_id=${encodeURIComponent(produitId)}&depot_id=${encodeURIComponent(depotId)}`)
      .then(r => r.json())
      .then(json => {
