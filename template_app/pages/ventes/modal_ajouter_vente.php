...
<div class="modal fade" id="ajouterVenteModal" tabindex="-1" aria-labelledby="ajouterVenteLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="formAjouterVente" method="POST" action="/{{TENANT_DIR}}/api/ventes/ajouter.php">
...
function mettreAJourStock(index) {
  ...
  fetch(`/{{TENANT_DIR}}/api/ventes/get_stock.php?produit_id=${encodeURIComponent(produitId)}&depot_id=${encodeURIComponent(depotId)}`)
    .then(r => r.json())
    .then(json => {
