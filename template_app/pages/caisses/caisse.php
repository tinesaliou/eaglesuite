...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <a class="btn btn-secondary btn-sm" href="/{{TENANT_DIR}}/index.php?page=tresorerie">Retour</a>
  </div>
    ...
    <tbody>
      <?php foreach($operations as $op): ?>
        <tr>
          ...
          <td><?= htmlspecialchars($op['reference_table'], ENT_QUOTES, 'UTF-8' . ' #' . $op['reference_id']) ?></td>
          <td><?= htmlspecialchars($op['user_name'], ENT_QUOTES, 'UTF-8' ?? '-') ?></td>
          <td><a href="/{{TENANT_DIR}}/api/caisses/imprimer.php?id=<?= $op['id'] ?>" 
