...
$profilePhoto = $user["photo"]
    ? "/{{TENANT_DIR}}/public/uploads/profiles/" . $user["photo"]
    : "/{{TENANT_DIR}}/public/icone/default_user.png";
?>
...
<div class="d-flex align-items-center justify-content-between mb-4"
    ...
    <div class="d-flex align-items-center">
        <img src="/{{TENANT_DIR}}/public/icone/logoeaglesuite.png" alt="logo" style="height:50px;">
        <h4 class="ms-3 mb-0">Mon Profil</h4>
    </div>

    <a href="/{{TENANT_DIR}}/index.php?page=dashboard" class="btn btn-outline-warning">
...
<div class="profile-container" style="max-width:900px;margin:auto;">
    ...
    <div class="card p-4 shadow-sm mb-4">
        ...
        <div class="text-center mb-4">
            ...
            <form action="/{{TENANT_DIR}}/update_profile.php" method="POST" enctype="multipart/form-data" class="mt-3">
        ...
        <form action="/{{TENANT_DIR}}/update_profile.php" method="POST">
            <div class="row mt-3">
        ...
        <form action="/{{TENANT_DIR}}/change_password.php" method="POST" class="mt-3">
