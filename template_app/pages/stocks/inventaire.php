        ...
        <div class="card-body">
            <form method="get" class="row g-2 align-items-end">
                ...
                <div class="col-md-8 text-end">
                    ...
                    <a href="/{{TENANT_DIR}}/index.php?page=inventaire" class="btn btn-outline-secondary">Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modalAjuster" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <form id="formAjuster" method="post" action="/{{TENANT_DIR}}/pages/inventaire/update_stock.php" class="modal-content">
