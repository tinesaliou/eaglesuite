...
<div class="container-fluid pos-page">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item">
            <a href="/{{TENANT_DIR}}/index.php?page=dashboard">Tableau de bord</a>
        </li>
    ...
    <div class="alert alert-info d-flex justify-content-between">
        ...
        <div>
            <a href="/{{TENANT_DIR}}/index.php?page=fermer_caisse"
                   ...
                   <div class="col-md-3 mb-3 produit-card"data-categorie="<?= (int)$p['categorie_id'] ?>">
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <?php if (!empty($p['image'])): ?>
                                <img src="/{{TENANT_DIR}}/public/uploads/produits/<?= htmlspecialchars($p['image'], ENT_QUOTES, 'UTF-8') ?>"
                            ...
                            <div class="card-body text-center">
                                <h6><?= htmlspecialchars($p['nom'], ENT_QUOTES, 'UTF-8') ?></h6>
                ...
                <div class="row text-center g-3">
                    ...
                    <div class="col-6">
                        <div class="card paiement-card"
                            ...
                            <img src="/{{TENANT_DIR}}/public/money/wave.png" height="40">
                            <p class="mt-2">Wave</p>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="card paiement-card"
                            ...
                            <img src="/{{TENANT_DIR}}/public/money/om.png" height="40">
...
<script src="/{TENANT_DIR}}/public/js/pos.js"></script>
