        ...
        <div class="col-md-4 mb-3">
            <div class="card shadow-sm h-100">
              <div class="card-body d-flex flex-column">
                ...
                <div class="mt-auto">
                  <!-- <a href="/eaglesuite/index.php?page=caisse_<:?= strtolower($c['type']) ?>" class="btn btn-outline-primary btn-sm">Voir la caisse</a> -->
                   <?php
                    $pageMap = [
                    ...
                    ?><a href="/eaglesuite/index.php?page=<?= $page ?>" 
      ...
      <div class="card-body">
        <form method="get" class="row g-3">
          ...
          <div class="col-md-3 d-flex align-items-end">
            ...
            <a href="/eaglesuite/index.php?page=tresorerie" class="btn btn-outline-secondary">Réinitialiser</a>
          </div>
        </form>
      </div>
    </div>
