...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a class="btn btn-outline-secondary" href="/eaglesuite/index.php?page=crm_clients">← Retour</a>
            <!-- <a class="btn btn-primary" href="/eaglesuite/index.php?page=crm_client&action=edit&id=<!?= $client['idClient'] ?>">Modifier</a> -->
        </div>
    </div>
