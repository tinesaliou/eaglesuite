...
<div class="container-fluid px-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="/eaglesuite/index.php?page=crm_clients" class="btn btn-secondary btn-sm">
                <i class="fa fa-arrow-left"></i> Retour
            </a>

            <a href="/eaglesuite/index.php?page=crm_client&action=edit&id=<?= $id ?>" 
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="oppsTab">
            ...
            <div class="d-flex justify-content-between mb-2">
                <h5>Opportunités</h5>
                <a class="btn btn-success btn-sm" href="/eaglesuite/index.php?page=crm_opportunites&action=add&client_id=<?= $id ?>">
...
<div class="modal fade" id="modalInteraction">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="/eaglesuite/pages/crm/interaction_add.php">
